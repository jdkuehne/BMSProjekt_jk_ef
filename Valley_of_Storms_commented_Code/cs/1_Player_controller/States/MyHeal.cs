...
[CreateAssetMenu(menuName = "MyStates/Character/Heal")]
public class MyHeal : MyState<MyCharacterCtrl, int>
{
    ...
    public override void WhileRunning()
    {
        ...
        if (_stateTime >= _pParams.HealDuration && !_left)
        {
            _left = true;
    ...
    {
        _control.GetComponent<HealthV2>().Heal((int)_pParams.HealAmount);
        _control.GetComponent<Flask>().Decrement();        
    }
